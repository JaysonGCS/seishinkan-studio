...
export const Footer = async () => {
  ...
  return (
    <footer className="absolute bottom-0 flex h-footer w-full flex-col content-evenly items-center justify-between bg-background px-5 py-3 text-center text-foreground">
      <span className="text-base lg:text-xl">誠心館</span>
